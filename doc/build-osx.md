...
Bitcoin Ultra is now available at `./src/BTSd`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=bitcoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "$HOME/Library/Application Support/bitcoinTransfer/bitcoinTransfer.conf"

    chmod 600 "$HOME/Library/Application Support/bitcoinTransfer/bitcoinTransfer.conf"

The first time you run BTSd, it will start downloading the blockchain. This process could take several hours.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/bitcoinTransfer/debug.log

Other commands:
-------

    ./src/BTSd -daemon # Starts the bitcoin daemon.
