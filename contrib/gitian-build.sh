...
then
	...
	then
	    ...
	    mv build/out/bitcoin-Ultra-*.tar.gz build/out/src/bitcoin-Ultra-*.tar.gz ../bitcoin-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    mv build/out/bitcoin-Ultra-*-win-unsigned.tar.gz inputs/bitcoin-Ultra-win-unsigned.tar.gz
	    mv build/out/bitcoin-Ultra-*.zip build/out/bitcoin-Ultra-*.exe ../bitcoin-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    mv build/out/bitcoin-Ultra-*-osx-unsigned.tar.gz inputs/bitcoin-Ultra-osx-unsigned.tar.gz
	    mv build/out/bitcoin-Ultra-*.tar.gz build/out/bitcoin-Ultra-*.dmg ../bitcoin-binaries/${VERSION}
	fi
	popd
...
then
	...
	then
	    ...
	    mv build/out/bitcoin-Ultra-*win64-setup.exe ../bitcoin-binaries/${VERSION}
	    mv build/out/bitcoin-Ultra-*win32-setup.exe ../bitcoin-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    mv build/out/bitcoin-Ultra-osx-signed.dmg ../bitcoin-binaries/${VERSION}/bitcoin-Ultra-${VERSION}-osx.dmg
	fi
	popd
